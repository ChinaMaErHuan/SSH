...
public class TzUpdater {
	...
	protected TzUpdater(Object bean) {
		this.bean = bean;
	}
	 ...
	 * @return
	 */
	public static TzUpdater create(Object bean) {
		return new TzUpdater(bean);
	}
	 ...
	 * @return
	 */
	public static TzUpdater create(Object bean, UpdateMode mode) {
		TzUpdater updater = new TzUpdater(bean);
	 ...
	 * @return
	 */
	public TzUpdater setUpdateMode(UpdateMode mode) {
		this.mode = mode;
		return this;
	}
	 ...
	 * @return
	 */
	public TzUpdater include(String property) {
	 ...
	 * @return
	 */
	public TzUpdater exclude(String property) {
